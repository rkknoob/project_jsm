                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="FormLogin">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="password_con"
                                                placeholder="New Password Comfirm" name="password_con">
                                        </div>
...
$('body').on('click', '.btn-save', function() {
    ...
    $.ajax({
        ...
        url: '/cms/resetpassword/update/' + id,
        success: function(datas) {
            ...
            if (datas.code == 500) {
                ...
                setTimeout(function() {
                    window.location.replace(base_url + '/cms/home')
                }, 1000);
