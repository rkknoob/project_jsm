...
<div>
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Add Find A Store Form</h1>
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="detail" class="summernotenstore" id="summernotenstore"></textarea>
                                </div>

                                <div class="form-group" >
                                    <label for="editor"><b>Detail Text TH</b><font color="red">*</font></label><br>
                                    <!-- Create the editor container -->
                                    <textarea name="detail" class="summernotethstore" id="summernotethstore"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tel" id="tel" placeholder="Enter Tel" >
                                </div>

                                <div class="form-group">
                                    <label for="fname"><b>Google Maps</b><font color="red">*</font></label>
                                    <textarea type="text" class="form-control" name="map" id="map" placeholder="Enter Google Map" rows="5" cols="50"></textarea>
                                </div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.btn-save', function () {
        ...
        $.ajax({
            dataType: 'json',
            type:'POST' ,
            data:{name_en:name_en,name_th:name_th,type:type,is_active:is_active,img1:image,detail_en:summernoten,detail_th:summernoteth,address:address,tel:tel,map:map},
            url: '/cms/store',
