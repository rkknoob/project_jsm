            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align:right; margin: 0 0 2% 0;">
                        <a href="/cms/store/plops/create" class="btn btn-success">
                            Add Store Category
                        </a>
                    </div>
                </div>
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var dataid = row.id;
                        var btnEdit = '<a role="button"  href="/cms/store/plops/edit/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                        var btnDelete = '<a role="button" href="#" data-href="/store/plops/' + data + '" data-name="' + dataName + '"  data-id="' + dataid + '"  class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> Delete</a>';
