...
@section('content')
    ...
    <div>
        ...
        <h1 class="h3 mb-4 text-gray-800">
            ...
            @if($status == 'edit')
                Edit Find Store Category Form
            @else
                Add Find Store Category Form
            @endif
        </h1>
                            ...
                            <div class="box-body col-md-12">
                                <div class="form-group col-md-12">
                                        <div class="form-group">
                                            ...
                                            @if($status == 'edit')
                                                <input type="text" class="form-control" name="name_en" id="name_en" placeholder="Enter Name En"  value="{{$faq->name_en}}">
                                            @else
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        <label for="nameen"><b>Name Th</b><font color="red">*</font></label>
                                        @if($status == 'edit')
                                            <input type="text" class="form-control" name="name_th" id="name_th" placeholder="Enter Name Th"  value="{{$faq->name_th}}">
                                        @else
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        <label for="nameen"><b>Sorting</b><font color="red">*</font></label>
                                        @if($status == 'edit')
                                            <input type="text" class="form-control" name="sorting" id="sorting" placeholder="Enter Sorting"  value="{{$faq->sorting}}">
                                        @else
                                            <input type="text" class="form-control" name="sorting" id="sorting" placeholder="Enter Sorting"  value="">
                                        @endif
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if((name_en == '') || (name_th == '') || (is_active == '')||(sorting =="")){
            ...
            if(status == 'edit'){
                ...
                $.ajax({
                    dataType: 'json',
                    type:'PUT' ,
                    data:{id:id,name_en:name_en,name_th:name_th,is_active:is_active,sorting:sorting},
                    url: '/cms/store/plops/' + id,
                    ...
                    //    window.location.replace(base_url+'/backoffice/artist/magazine')
                        window.location.replace(base_url+'/cms/store/plops')
                    }
                });
                ...
                $.ajax({
                    dataType: 'json',
                    type:'POST',
                    data:{name_en:name_en,name_th:name_th,is_active:is_active,sorting:sorting},
                    url: '/cms/store/plops',
                    success: function(datas){
                        console.log(datas);
                        swal("Good job!", "You clicked the button!", "success");
