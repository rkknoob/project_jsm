...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Manage List Find Store Category</h1>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align:right; margin: 0 0 2% 0;">
                        <a href="/cms/faq/settingfaq-cate/create" class="btn btn-success">
                            Add Faq Category
                        </a>
                    </div>
                </div>
        ...
        var table = $('#dataTable').DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, row) {
                    ...
                    var btnEdit = '<a role="button"  href="/cms/faq/settingfaq-cate/' + dataid +'/edit" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                    //var btnDelete = '<a role="button"  href="' + dataid +'"   class="btn btn-outline-danger btn-sm btn-delete" data-id="' + dataid + '"><i class="fa fa-trash"></i> Delete</a> ';
                    
                    var btnDelete = '<a role="button" href="#" data-href="/faq/settingfaq-cate/' + data + '" data-name="' + dataName + '"  data-id="' + dataid + '"  class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> Delete</a>';
