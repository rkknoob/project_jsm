...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Edit Q&A Form</h1>
                            ...
                            <div class="box-body col-md-12">
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" name="id" id="id"  value="{{$topic['id']}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="hit" id="hit" placeholder="Enter Hit"  value="{{$topic['hit']}}" maxlength="1">
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if((title == '' ) || (hit == '') || (type == '') || (status =='') || (content == '') ){
