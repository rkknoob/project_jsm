...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Manage List Q&A Reply</h1>
        ...
        var table = $('#dataTable').DataTable({
            ...
            },
            {
                    ...
                    render: function (data, type, row) {
                        ...
                        var dataid = row.id;
                        var btnView = '<a role="button"  href="replyqa/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> View</a> ';
                        return btnView;
