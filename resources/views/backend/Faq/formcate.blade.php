                            ...
                            <div class="box-body col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        ...
                                        @if($status == 'edit')
                                            <input type="text" class="form-control" name="name_th" id="name_th" placeholder="Enter Subject"  value="{{$faq->name_th}}">
                                        @else
                                            <input type="text" class="form-control" name="name_th" id="name_th" placeholder="Enter Subject"  value="">
                                        @endif
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if(status == 'edit'){
                ...
                $.ajax({
                    dataType: 'json',
                    type:'PUT' ,
                    data:{id:id,name_en:name_en,name_th:name_th,is_active:is_active},
                    url: '/cms/faq/settingfaq-cate/' + id,
                    ...
                    //    window.location.replace(base_url+'/backoffice/artist/magazine')
                        window.location.replace(base_url+'/cms/faq/settingfaq-cate')
                    }
                });
                ...
                $.ajax({
                    dataType: 'json',
                    type:'POST',
                    data:{name_en:name_en,name_th:name_th,is_active:is_active},
                    url: '/cms/faq/settingfaq-cate',
                    success: function(datas){
                        console.log(datas);
                        swal("Good job!", "You clicked the button!", "success");
