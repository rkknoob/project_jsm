...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Manage List Notice</h1>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align:right; margin: 0 0 2% 0;">
                        <a href="{{ url('cms/notice/add') }}" class="btn btn-success">
                            Add Notice
                        </a>
                    </div>
                </div>
        ...
        var table = $('#dataTable').DataTable({
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    searchable: false,
                    render: function (data, type, row) {
                        var dataName = row.content;
                        var dataid = row.id;
                        var btnEdit = '<a role="button"  href="notice/edit/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                        var btnDelete = '<a href="#" data-href="/notice/' + data + '" data-name="' + dataName + '"  data-id="' + dataid + '" role="button" class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> Delete</a>';
