...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Edit Admin Form</h1>
                            ...
                            <div class="box-body col-md-12">
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="fname" id="fname" placeholder="Enter Name"  value="{{$item['fname']}}">
                                    </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="lname" id="lname" placeholder="Enter Name"  value="{{$item['lname']}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12" hidden>
                                    <div class="form-group">
                                        <label for="name_th"><b>Password</b></label>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if((finame == '') || (liname == '') || (email == '') || (is_active == '')){
            ...
            $.ajax({
                dataType: 'json',
                type:'put' ,
                data:{id:id,fname:finame,lname:liname,email:email,is_active:is_active,token:token},
                url: '/cms/admin/edit/save/' + id,
