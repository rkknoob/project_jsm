...
@section('content')
    ...
    <div>
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Manage List Admin</h1>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align:right; margin: 0 0 2% 0;">
                        <a href="/cms/admin/add" class="btn btn-success">
                            Add Admin
                        </a>
                    </div>
                </div>
              ...
              ,{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var dataid = row.id;
                        var btnEdit = '<a role="button"  href="/cms/admin/edit/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                        return btnEdit;
