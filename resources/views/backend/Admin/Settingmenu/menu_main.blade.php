...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Setting Menu Main</h1>
    ...
    <script type="text/javascript">
        ...
        var table = $('#dataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:  "{!! route('settingmainmenu.data') !!}",
                method: 'POST',
                data: RefreshTable,
            ...
            columnDefs: [{
                ...
                render: function (data, type, row) {
                    var result = data ?  '<i class="' + data +'">' : '<i class="' + data +'">';
                    return result;
                ...
                render: function (data, type, row) {
                    ...
                    render: function (data, type, row) {
                        ...
                        var btnEdit = '<a role="button"  href="/cms/settingmenu-mainmenu/' + dataid +'/edit" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                        return btnEdit;
                    }
                },
            ]
