...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Setting Sub Main</h1>
        ...
        var table = $('#dataTable').DataTable({
            ...
            columnDefs: [{
                ...
                render: function (data, type, row) {
                    ...
                    var btnEdit = '<a role="button"  href="/cms/settingmenu-mainmenu-submenu/' + dataid +'/edit" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                    return btnEdit;
                }
            },
            ]
