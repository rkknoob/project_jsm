...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Setting Group Menu</h1>
                ...
                render: function (data, type, row) {
                    ...
                    render: function (data, type, row) {
                       ...
                       // var btnView = '<a role="button"  href="/backoffice/settingmenu/' + dataid +'" class="btn btn-outline-dark btn-sm btn-view"><i class="fa fa-edit"></i> View</a> ';
                        var btnEdit = '<a role="button"  href="/cms/settingmenu/' + dataid +'/edit" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                        return btnEdit;
                    }
                },
            ]
