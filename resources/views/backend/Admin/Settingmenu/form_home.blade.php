...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Edit Group Menu</h1>
                            ...
                            <div class="box-body col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sort" id="sort" placeholder="Enter Sort Id  Number"  value="{{$data_menu->sort}}" maxlength="1">
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    <div class="form-group">
                                        <label for="sort_id"><b>Parent Id</b><font color="red">*</font></label>
                                        <input type="text" class="form-control" name="parent_id" id="parent_id" placeholder="Enter Sort Id  Number"  value="{{$data_menu->parent_id}}" maxlength="1">
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $('#sort').keypress(function(event){
            ...
            if(event.which != 8 && isNaN(String.fromCharCode(event.which)) && isNaN(String.fromCharCode(event.which) == 0) ){
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if( (name_en == '') || (name_th =='')  || (sort_id == '') || (parent_id == '')){
            ...
            $.ajax({
                dataType: 'json',
                type:'PUT' ,
                data:{id:id,name_en:name_en,name_th:name_th,sort:sort_id,parent_id:parent_id},
                url: '/cms/settingmenu-home/' + id,
                success: function(datas){
                    ...
                    if(datas.code == 500){
                        ...
                        setTimeout(function(){
                            window.location.replace(base_url+'/cms/settingmenu-home')
                            }, 1000);
