...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Manage List Introduction</h1>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable"  class="display" width="100%" cellspacing="0">
                        ...
                        <tr class="center">
                            ...
                            <th>Name En</th>
                            <th>Name Th</th>
                            <th style="width:180px">Picture Eng</th>
                            <th>Status</th>
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var dataid = row.id;
                        var btnEdit = '<a role="button"  href="artist/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
