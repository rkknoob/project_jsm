                        ...
                        <div class="box">
                            ...
                            <div class="box-body col-md-12">
                                <div class="form-group col-md-12">
                                    @if($status == 'edit')
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name_en" id="name_en" placeholder="Enter Name Magazine"  value="{{ $data_magazine->name_en }}">
                                        </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    @if($status == 'edit')
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name_th" id="name_th" placeholder="กรอก ภาษาไทย"  value="{{ $data_magazine->name_th }}">
                                        </div>
                                    ...
                                    @else
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name_th" id="name_th" placeholder="กรอก ภาษาไทย"  value="">
                                        </div>
                                    @endif
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group" style="padding-left:15px;">
                                    <label for="filemagazine"><B>File Magazine</B><font color="red">*</font></label><br>
                                    ...
                                    @else
                                        <img src="{{ $image_display }}" alt="รูปภาพประจำสินค้า" class="img-fluid rounded mx-auto d-block profile-image" id="showImage" >
                                    @endif
                                ...
                                <div class="form-group"hidden>
                                    ...
                                    @if($status == 'edit')
                                        <textarea name="summernoten" class="summernoten" id="summernoten">{{ $data_magazine->detail_en }}</textarea>
                                    @else
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    Create the editor container
                                    @if($status == 'edit')
                                        <textarea name="summernoteth" class="summernoteth" id="summernoteth">{{ $data_magazine->detail_th }}</textarea>
                                    @else
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if(status == 'edit'){
                ...
                $.ajax({
                    dataType: 'json',
                    type:'PUT' ,
                    data:{id:id,name_en:name_en,name_th:name_th,img_url:file,status:status,type:'M',is_active:is_active},
                ...
                $.ajax({
                    dataType: 'json',
                    type:'POST',
                    data:{name_en:name_en,name_th:name_th,img_url:file,status:status,is_active:is_active,type:'M'},
