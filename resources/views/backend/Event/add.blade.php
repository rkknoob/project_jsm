...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Add Event Form</h1>
                            ...
                            <div class="box-body col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control daterangepicker-field" id="daterange" name="daterange" />
                                ...
                                <div class="form-group">
                                    <label for="editor"><b>Detail Text EN</b><font color="red">*</font></label><br>
                                        ...
                                        <textarea name="detail" class="summernoteen" id="summernoteen"></textarea>
                                </div>
    ...
    <script>
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if( (name_en == '') ||(name_th == '') || (is_active =='')  || (summernoteen == '') || (summernoteth == '') || (imagecolor == '') || (imageproduct == '') || (date == '')){
            ...
            $.ajax({
                dataType: 'json',
                type:'POST',
                data:{topic_en:name_en,topic_th:name_th,is_active:is_active,banner1:imagecolor,banner2:imageproduct,detail_en:summernoteen,detail_th:summernoteth,start_date:start_date,end_date:end_date},
                url: '/cms/event',
                success: function(datas){
                    swal("Good job!", "You clicked the button!", "success");
                    window.location.href = '/cms/event'
                }
            })
        });
