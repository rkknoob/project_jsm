...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Manage List New Arrival</h1>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align:right; margin: 0 0 2% 0;">
                        <a href="{{ url('cms/linestory/add') }}" class="btn btn-success">
                            Add New Arrival
                        </a>
                    </div>
                </div>
            ...
            columnDefs: [{
            ...
            },
                {
                    ...
                    render: function (data, type, row) {
                        var result = data ? '<img src="/public/linestory/' + data + '" alt="' + row.name + '" class="img-fluid rounded mx-auto">' : '';
                        return result;
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        var dataid = row.id;
                        var btnEdit = '<a role="button"  href="linestory/edit/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                        var btnDelete = '<a href="#" data-href="/linestory/' + data + '" data-name="' + dataName + '"  data-id="' + dataid + '" role="button" class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> Delete</a>';
