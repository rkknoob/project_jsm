...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Add New Arrival Form</h1>
                                ...
                                <div class="col-sm-12 col-12">
                                    <div class="row">
                                        <div class="col-sm-6 col-12 padding-zero">
                                            ...
                                            <img src="{{ $image_display }}" alt="Img Line Story" class="img-fluid rounded mx-auto d-block profile-image" id="showImage" >
                                        </div>
    ...
    <script>
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            $.ajax({
                dataType: 'json',
                type:'POST',
                data:{name_en:name_en,is_active:is_active,banner_en:image,file:file},
                url: '/cms/linestory',
        ...
        if($('input[name=id]').val()) {
            axios.get($backoffice_url + '/linestory/' + $('input[name=id]').val() + '/images')
