...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Edit New Arrival Form</h1>
            ...
            <div class="collapse show" id="collapseCardExample" >
                <div class="card-body">
                    ...
                    <form name="myForm" action="#" id="productForm" onsubmit="return validateForm()" method="post">
                        ...
                        <input type="hidden" name="id_line" id="id_line" value="{{$product->id}}">
                        <input type="hidden" name="image" id="image" value="{{$product->banner_en}}">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body col-md-12">
                                ...
                                <div class="col-sm-12 col-12">
                                    <div class="row">
                                        <div class="col-sm-6 col-12 padding-zero">
                                            <label><b>Banner Image</b><font color="red">*(ขนาดรูป 1140*400)</font></label><br>
                                            <input type="file" name="file_upload" id="file_upload">
                                            <img src="/public/linestory/{{ $product->banner_en }}" alt="Img Line Story" class="img-fluid rounded mx-auto d-block profile-image" id="showImage" >
                                        </div>
    ...
    <script>
        ...
        var $link = "<?php echo url('/public/linestory/'); ?>";
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            if((name_en == '' ) || (is_active =='') || (image == '') ||(file == '') ){
            ...
            $.ajax({
                dataType: 'json',
                type:'POST',
                data:{id:id,name_en:name_en,is_active:is_active,banner_en:image,file:file,deletefile_id,deletefile_id},
                url: '/cms/linestory/update',
                success: function(datas){
                    console.log(datas);
                    swal("Good job!", "You clicked the button!", "success");
                    window.location.href = '/cms/linestory'
                }
            })
        });
        ...
        if($('input[name=id_line]').val()) {

            axios.get($backoffice_url + '/linestory/' + $('input[name=id_line]').val() + '/images')
