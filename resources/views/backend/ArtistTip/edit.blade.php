...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Edit Artist Tip Form</h1>
            ...
            <div class="collapse show" id="collapseCardExample" >
                <div class="card-body">
                    ...
                    <form name="myForm" action="#" id="productForm" onsubmit="return validateForm()" method="post">
                        ...
                        <input type="hidden" name="image" id="image" value="{{ $item->img_banner }}">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_en" id="name_en" placeholder="Enter Name" value="{{ $item->title_en }}">
                                </div>
                                <div class="form-group">
                                    <label for="fname"><b>Name Th</b><font color="red">*</font></label>
                                    <input type="text" class="form-control" name="name_th" id="name_th" placeholder="Enter Name" value="{{ $item->title_th }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="col-sm-12 col-12">
                                    <div class="row">
                                        <div class="col-sm-4 col-12 padding-zero">
                                            ...
                                            <img src="/public/artisttip/{{ $item->img_banner }}" alt="Img Artist Tip" class="img-fluid rounded mx-auto d-block profile-image" id="showImage" >
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="detail" class="summernotentip" id="summernotentip">{{ $item->detail_en }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="editor"><b>Detail Text TH</b><font color="red">*</font></label><br>
                                    <!-- Create the editor container -->
                                    <textarea name="detail" class="summernotethtip" id="summernotethtip">{{ $item->detail_th }}</textarea>
                                </div>
                            </div>
        ...
        */
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            $.ajax({
                dataType: 'json',
                type:'PUT' ,
                data:{id:id,title_en:name_en,title_th:name_th,is_active:is_active,img_banner:image,detail_th:summernoteth,detail_en:summernoten},
                url: '/cms/artistTip/update',
