...
@section('content')
    ...
    <div>
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Edit Sku Form</h1>
            ...
            <div class="collapse show" id="collapseCardExample" >
                <div class="card-body">
                    ...
                    <form name="myForm" action="#" id="skuForm" method="post">
                        <input type="hidden" name="id" id="id" value="{{ $itemProduct->id }}">
                        <input type="hidden" name="imagecolor" id="imagecolor" value="{{ $itemProduct->img_color }}">
                        <input type="hidden" name="imageproduct" id="imageproduct" value="{{ $itemProduct->img_product }}">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="idproduct" class="form-control" id="idproduct" required>
                                        ...
                                        @foreach($itemDetail as $product)
                                            <option value="{{$product->id}}" @if($product->id==$item->id){{'selected'}}@endif > {{$product->name_en}} </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code_sku" id="code_sku" value="{{ $itemProduct->sku }}" placeholder="Enter Code Sku">
                                </div>

                                <div class="form-group">
                                    <label for="fname"><b>Name Sku</b><font color="red">*</font></label>
                                    <input type="text" class="form-control" name="name_sku" id="name_sku" value="{{ $itemProduct->name_en }}" placeholder="Enter Name Sku">
                                </div>

                                <div class="form-group">
                                    <label for="is_active"><b>Status</b><font color="red">*</font></label>
                                    <select class="form-control" name="is_active" id="is_active">
                                        <option value="Y"  @if($itemProduct->is_active=="Y"){{'selected'}}@endif>Yes</option>
                                        <option value="N"  @if($itemProduct->is_active=="N"){{'selected'}}@endif>No</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="row">
                                        <div class="col-sm-4 col-12 padding-zero">
                                            ...
                                            <img src="@if($itemProduct->img_color!=null)/public/color/{{ $itemProduct->img_color }}@else {{ $image_display }} @endif" alt="รูปภาพประจำสินค้า" class="img-fluid rounded mx-auto d-block profile-image" id="showImageColor" >
                                        </div>
                                        ...
                                        <div class="col-sm-4 col-12 padding-zero">
                                            ...
                                            <img src="@if($itemProduct->img_color!=null)/public/colorproduct/{{ $itemProduct->img_product }}@else {{ $image_display }} @endif" alt="รูปภาพประจำสินค้า" class="img-fluid rounded mx-auto d-block profile-image" id="showImageProduct" >
                                        </div>
                                        <div class="col-sm-2 padding-zero">
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.btn-save', function () {
            ...
            $.ajax({
                dataType: 'json',
                type:'POST',
                data:{id:id,sku:code_sku,is_active:is_active,name_en:name_sku,product_id:idproduct,img_color:imagecolor,img_product:imageproduct},
                url: '/cms/sku/update',
                success: function(datas){
                    //swal("Good job!", "You clicked the button!", "success");
                    //window.location.href = '/backoffice/sku'
