...
<div>
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Manage List Film</h1>
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    var dataid = row.id;
                    var btnEdit = '<a role="button"  href="brandcontent/' + dataid +'" class="btn btn-outline-dark btn-sm btn-edit"><i class="fa fa-edit"></i> Edit</a> ';
                    var btnDelete = '<a href="#" data-href="/brandcontent/' + data + '" data-name="' + dataName + '"  data-id="' + dataid + '" role="button" class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> Delete</a>';
