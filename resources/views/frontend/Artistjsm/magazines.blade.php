...
<div id="ju-container">
    <div id="ju-content" class="container">
        ...
        <ul class="nav nav-tabs">
            <li><a href="/artist" class="letters">@lang('lang.introduction')</a></li>
            <li class="active"><a href="/artist/magazines" class="letters">@lang('lang.magazine')</a></li>
        </ul>
        ...
        <div class="bbs-table-list" style="padding: 15px 0px;">
            <div class="fixed-img-collist video-list">
                @foreach ($magazzine as $chunk)
                <div class="row">
                    @foreach ($chunk as $Magazines)
                   
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="box">
                            <a href="/artist/magazine/media/cid/{{$Magazines->id}}" class="video_link">
                                <div class="video_txt">
                                    <h5 class="letters">
                                        @if($locale==='th')
                                        {{ $Magazines->name_th }}
                                ...
                                <div class="video-thumbnail">
                                    <img src="{{ url('/public/magazine/'.$Magazines->img_url) }}"
