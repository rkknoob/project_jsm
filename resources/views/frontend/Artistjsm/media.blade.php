...
<div id="ju-container">
    <div id="ju-content" class="container">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="/artist" class="letters">@lang('lang.introduction')</a></li>
            <li><a href="/artist/magazines" class="letters">@lang('lang.media')</a></li>
        </ul>
        <h3 class="letters">
            @if($locale==='th')
        ...
        <div class="view-link col-sm-4 col-sm-offset-4" b style="padding-bottom:30px;">
            <dl class="bbs-link">
                <dd>
                    <a class="displaynone"></a><a href="/artist/magazines" class="btn btn-primary btn-lg btn-block">
                        View List</a>
                </dd>
            </dl>
        </div>
