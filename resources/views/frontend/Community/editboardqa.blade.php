    ...
    <div id="ju-container">
        <div id="ju-content" class="container">
            ...
            <div class="bbs-table-write" >
                ...
                @endif
                <form action="{{url('qa/board/save')}}"  method="post">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <table summary="" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="title">
                                    ...
                                    <input type="text" name="title" value="{{$topic->title}}" style="width:400px;" class="MS_input_txt" maxlength="80">
                                </div>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div class="title">
                                    <select class="MS_select MS_input_txt idcategory" name="idcategory" id="idcategory" >
                                        ...
                                        @foreach($cate_product as $cate_products)
                                            <option value="{{$cate_products->id}}"  {{ $cate_products->id==$cate_id ? 'selected' : '' }}> {{$cate_products->name}} </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="MS_select MS_input_txt idproduct" name="product_id" id="product_id">
                                        ...
                                        @foreach($product as $products)
                                            <option value="{{$products->id}}" {{ $products->id==$topic_product ? 'selected' : '' }}> {{$products->name_en}} </option>
                                        @endforeach
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div>
                                    <textarea name="content" class="summernoten" id="content">{{ $topic['content'] }}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <th class="text-size">Code</th>
                            <td colspan="12"><input type="text" name="captcha" class="MS_input_txt " style="width: 130px; margin-right: 5px" placeholder="Enter Captcha"><span id="oldDiv"></span><div class="btn-sp btn-galbh21" style="vertical-align: middle; margin-left: 5px"><div class="captcha"><span>{!! captcha_img() !!}</span></div><button type="button" class="btn btn-success btn-refresh" id="refresh"><i class="fa fa-refresh"></i></button></span></td>
                        </tr>
