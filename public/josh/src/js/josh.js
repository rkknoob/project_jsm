...
$(function() {
    ...
    $("[data-toggle='offcanvas']").click(function(e) {
        ...
        //If window is small enough, enable sidebar push listmenu
        if ($(window).width() <= 992) {
 ...
 * SIDEBAR MENU
 * ------------
 * This is a custom plugin for the sidebar listmenu. It provides a tree view.
 * 
 * Usage:
 * $(".sidebar).tree();
 * 
 * Note: This plugin does not accept any options. Instead, it only requires a class
 *       added to the element that contains a sub-listmenu.
 *       
 * When used with the sidebar, for example, it would look something like this:
 * <ul class='sidebar-listmenu'>
 *      <li class=" active">
 *          <a href="#>Menu</a>
 *          <ul class='treeview-listmenu'>
 *              <li class='active'><a href=#>Level 1</a></li>
 *          </ul>
 *      </li>
 * </ul>
 * 
 * Add .active class to <li> elements if you want the listmenu to be open automatically
...
(function($) {
    ...
    $.fn.tree = function() {
        ...
        return this.each(function() {
            ...
            var listmenu = $(this).children(".treeview-listmenu").first();
            ...
            //Slide open or close the listmenu on link click
            btn.click(function(e) {
                e.preventDefault();
                $('.sidebar-listmenu').each(function() {
                    $('.treeview-listmenu').slideUp();
                ...
                /*if (isActive) {
                    //Slide up to close listmenu
                    listmenu.slideUp();
                    isActive = false;
                    btn.children(".fa-minus").first().removeClass("fa-minus").addClass("fa-plus");
                    btn.parent("li").removeClass("active");
                } else {
                    //Slide down to open listmenu
                    //alert('opening listmenu');
                    listmenu.slideDown();
                    //isActive = true;
                    btn.children(".fa-plus").first().removeClass("fa-plus").addClass("fa-minus");
            ...
            /*listmenu.find("li > a").each(function() {
